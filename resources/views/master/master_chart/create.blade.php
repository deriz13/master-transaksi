    ...
    <div class="row justify-content-center">
        ...
        <div class="col-lg-12">
            <div class="card shadow-lg border-0 rounded-lg mt-5">
                ...
                <div class="card-body">
                    <form action="{{ route('master_chart.store') }}" method="POST">
                        @csrf
                        @include('master.master_chart._form')
                        <div class="mt-4 mb-0">
                            <div class="d-flex justify-content-between">
                                <a href="{{ route('master_chart.index') }}" class="btn btn-danger w-50 text-center">Cancel</a>
